        ...
        if is_booking_enabled():
            tools.append({
                ...
                "description": (
                    ...
                    "Appointment times are in the business/appointment timezone. If caller_timezone is known and differs, the tool returns caller-local display too; offer caller-local time first, then appointment/business time. "
            ...
            tools.append({
                ...
                "description": (
                    ...
                    "Confirm the appointment timezone. If the slot includes caller_display, mention caller-local time first and appointment/business time second; never call the business appointment timezone 'my time'. "
